...
public class DepositReversalSix extends BaseClass{

	static Logger log = Logger.getLogger(IndCustomerStepDefinition.class);
	String className="";
	LoginAndLogOut_Page loginPage;
	
	@Given("^pre req for deposit reversalsix \"([^\"]*)\"$")
	public void pre_req_for_deposit_reversalsix(String TestcaseId) throws Throwable {
...
al.accept();*/
	...
	@Then("^user input the command in the Reversalsix text box \"([^\"]*)\"$")
	public void user_input_the_command_in_the_Reversalsix_text_box(String Command) throws Throwable {
	...
	@Then("^user reversessix financial activity \"([^\"]*)\"$")
	public void user_reversessix_financial_activity(String TestcaseId) throws Throwable {
	    System.out.println(TestcaseId);
		//Deposit_Page.ReversalThree(TestcaseId);
		 
		 Deposit_Page.Reversalsix(TestcaseId);
